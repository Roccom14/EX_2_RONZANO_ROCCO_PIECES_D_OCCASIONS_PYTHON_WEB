...
# au navigateur par la méthode "render_template".
# On change la valeur d'un gender de users par la commande MySql "UPDATE"
# ---------------------------------------------------------------------------------------------------
...
def genders_delete():
    ...
    if request.method == 'POST':
        try:
            ...
            # OM 2019.04.02 On va afficher la liste des genders des users
            ...
            # Cette erreur 1451, signifie qu'on veut effacer un "gender" de users qui est associé dans "t_genders_films".
