...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les users et les genders.
...
def genres_films_afficher():
    ...
    #         data_genres_films = obj_actions_genres_films.gender_afficher_data()
    #         # DEBUG bon marché : Pour afficher un message dans la console.
    #
    #         # OM 2020.04.09 La ligns ci-après permet de donner un sentiment rassurant aux utilisateurs.
    #         flash("Données genders de users affichées !!", "Success")
