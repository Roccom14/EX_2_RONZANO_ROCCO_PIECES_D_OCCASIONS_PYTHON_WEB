...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les films et les genders.
...
def genres_films_afficher():
    ...
    #         flash("Données genders de films affichées !!", "Success")
